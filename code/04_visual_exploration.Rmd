---
title: "Supplementary Text S4: Visual exploration of duplicated genes across the Eukarya tree of life"
author:
...
vignette: |
  %\VignetteIndexEntry{Supplementary Text S4}
...
```{r fig.height=14, fig.width=16, eval = TRUE}
